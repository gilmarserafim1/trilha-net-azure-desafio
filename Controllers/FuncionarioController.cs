...
public class FuncionarioController : ControllerBase
{
    ...
    public IActionResult Criar(Funcionario funcionario)
    {
        ...
        // OK: Chamar o método SaveChanges do _context para salvar no Banco SQL
        ...
        // OK: Chamar o método UpsertEntity para salvar no Azure Table
    ...
    public IActionResult Atualizar(int id, Funcionario funcionario)
    {
        ...
        // OK: As propriedades estão incompletas
        ...
        // OK: Chamar o método de Update do _context.Funcionarios para salvar no Banco SQL
    ...
    public IActionResult Deletar(int id)
    {
        ...
        // OK: Chamar o método de Remove do _context.Funcionarios para salvar no Banco SQL
